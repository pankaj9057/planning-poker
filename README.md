...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/pankaj9057/planning-poker)

### Deploy to GitHub Pages

```bash
npm run build
# Then use any static hosting service to host the 'dist' folder
```
